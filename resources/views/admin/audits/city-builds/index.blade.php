    ...
    <section class="nexus-panel" aria-labelledby="member-builds-heading">
        <div class="nexus-panel__header">
            <div>
                ...
                <p class="text-sm text-base-content/60">A city matches only when its improvements match the recommendation, it is powered, and it meets the target infrastructure and land.</p>
            </div>
        ...
        <div class="nexus-table-shell rounded-none border-x-0 border-t-0">
            <table class="nexus-table">
                    ...
                    <tr>
                        <td>
                            <div class="grid gap-1">
                                ...
                                <span class="text-sm text-base-content/60">{{ $member->leader_name }} · #{{ $member->id }} · C{{ $member->num_cities }}</span>
                            </div>
                        </td>
                        <td>
                            @if($audit['recommendation_status'] === 'ready')
                                <div class="grid gap-1">
                                    ...
                                    <span class="text-sm text-base-content/60">${{ number_format($recommendation->converted_profit_per_day, 2) }} per city/day</span>
                                </div>
                        ...
                        <td>
                            <div class="grid gap-1">
                                ...
                                @else
                                    <span class="text-sm text-base-content/60">{{ $audit['city_count'] }} tracked {{ \Illuminate\Support\Str::plural('city', $audit['city_count']) }}</span>
                                @endif
                    ...
                    <tr>
                        <td colspan="5" class="bg-base-200/40">
                            <details>
                                    ...
                                    <div class="grid gap-5 pt-4">
                                        <div class="grid gap-2">
                                            ...
                                            <div class="flex flex-wrap gap-2">
                                                ...
                                                @empty
                                                    <span class="text-sm text-base-content/60">No improvements were recommended.</span>
                                                @endforelse
                                            </div>
                                        </div>
                                        ...
                                        <div class="grid gap-3">
                                            ...
                                            @else
                                                <p class="text-sm text-base-content/60">No city records are available for this member.</p>
                                            @endif
                                        </div>
                                ...
                                @else
                                    <p class="pt-3 text-sm text-base-content/60">Generate a current recommendation before comparing this member's first city.</p>
                                @endif
                            </details>
                        </td>
                    </tr>
                @empty
                    <tr>
                        <td colspan="5" class="py-10 text-center text-base-content/60">No active members matched this search.</td>
                    </tr>
                @endforelse
                </tbody>
            </table>
